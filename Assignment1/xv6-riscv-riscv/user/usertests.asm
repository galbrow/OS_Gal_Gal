...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	44a78793          	addi	a5,a5,1098 # 8690 <big.1274>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	2f678793          	addi	a5,a5,758 # 8590 <args.1863>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3e668693          	addi	a3,a3,998 # 8688 <args.1863+0xf8>
    ...
    22be:	2d658593          	addi	a1,a1,726 # 8590 <args.1863>
